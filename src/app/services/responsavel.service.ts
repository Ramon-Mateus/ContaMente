...
export class ResponsavelService {
  ...
  getResponsaveis(): Observable<Responsavel[]> {
    return this.httpClient.get<Responsavel[]>(this.urlDoModel, {
      withCredentials: true,
    })
  }

  getResponsavelById(id: number): Observable<Responsavel> {
    return this.httpClient.get<Responsavel>(`${this.urlDoModel}/${id}`, {
      withCredentials: true,
    })
  }

  postResponsavel(responsavel: PostPutResponsavel): Observable<Responsavel> {
    return this.httpClient.post<Responsavel>(this.urlDoModel, responsavel, {
      withCredentials: true,
    })
  }
  ...
  putResponsavel(
    id: number,
    responsavel: PostPutResponsavel
