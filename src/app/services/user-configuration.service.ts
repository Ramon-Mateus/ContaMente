...
export class UserConfigurationService {
  ...
  getUserConfiguration(): Observable<UserConfiguration> {
    return this.httpClient.get<UserConfiguration>(this.urlDoModel, {
  ...
  ): Observable<UserConfiguration> {
    return this.httpClient.put<UserConfiguration>(this.urlDoModel, config, {
      withCredentials: true,
    })
  }
}
